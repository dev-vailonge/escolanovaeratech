...
export default function WebPage() {
  ...
  const modules = [
    {
      title: 'Fundamentos',
      description: 'Entenda os conceitos básicos do desenvolvimento web.',
      topics: [
        'O que é front-end, back-end e full stack',
        'Como funciona um site (navegador, servidor, código)',
        'O papel do HTML, CSS e JS no navegador',
        'Criando seu primeiro arquivo .html',
        'Ferramentas básicas: VS Code, Live Server, DevTools'
      ]
    },
    {
      title: 'HTML',
      description: 'Aprenda a estruturar o conteúdo das suas páginas web.',
      topics: [
        'Tags essenciais (html, head, body, h1-h6, p, etc)',
        'Atributos comuns (href, src, alt, target)',
        'Formulários: input, label, button, select, textarea',
        'Semântica básica: header, main, footer, section'
      ]
    },
    {
      title: 'CSS',
      description: 'Domine a estilização e o visual das suas páginas.',
      topics: [
        'Seletores, propriedades e valores',
        'Cores, fontes, tamanhos, espaçamentos',
        'Box model e display',
        'Posicionamento: flexbox básico',
        'Como usar classes para estilizar'
      ]
    },
    {
      title: 'JavaScript',
      description: 'Adicione interatividade e dinamismo aos seus sites.',
      topics: [
        'Variáveis, funções e eventos',
        'Manipulando elementos com document.querySelector()',
        'Eventos: click, input, submit',
        'Exibindo mensagens e mudando estilos',
        'Exemplo prático: formulários e interações'
      ]
    },
    {
      title: 'Tailwind CSS',
      description: 'Acelere seu desenvolvimento com utility-first CSS.',
      topics: [
        'O que é Tailwind e por que usar',
        'Conceito de utility-first',
        'Instalação e configuração com Vite ou CDN',
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Aprenda a criar sites modernos do zero com HTML, CSS e JavaScript.
              Domine as tecnologias fundamentais da web com projetos práticos.
            </motion.p>
            ...
            <div className="mb-16">
              <div className="mb-12">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">
                  Aprender a criar sites modernos e responsivos utilizando as tecnologias mais atuais do desenvolvimento web.
                  Dominar HTML, CSS e JavaScript, além de frameworks modernos como Tailwind CSS para criar interfaces profissionais.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {['HTML', 'CSS', 'JavaScript', 'Tailwind CSS', 'VS Code', 'DevTools', 'Git'].map((tech) => (
                    <span 
                      key={tech}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Projetos Práticos</h2>
            <p className="text-xl text-gray-400 mb-12">
              Durante o curso, você irá construir 5 projetos práticos para aplicar seus conhecimentos
