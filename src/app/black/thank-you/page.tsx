...
export default function BlackThankYouPage() {
  ...
  useEffect(() => {
    // Anima a barra de progresso até 90%
  ...
  // Dispara evento Lead ao clicar no botão do WhatsApp
      ...
      <main className="min-h-screen bg-black text-white flex items-center justify-center relative">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 text-center">
          ...
          >
            ...
            >
              Parabéns, você deu o primeiro passo para mudar sua vida através da
              programação.
            </motion.h1>
            ...
            >
              Falta apenas mais um passo, entre para o grupo do WhatsApp para não
