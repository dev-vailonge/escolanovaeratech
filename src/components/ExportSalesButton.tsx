...
export default function ExportSalesButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="bg-yellow-500 hover:bg-yellow-600 disabled:bg-yellow-700 text-black font-medium px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"
    >
      {isLoading ? (
        <>
